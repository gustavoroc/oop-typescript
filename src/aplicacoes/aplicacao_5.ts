...
for (let mes = 1; mes <= 12; mes++) {
  if (mes == 3) contaCliente1.sacar(100, new Date(2022, mes, 5));

  if (mes == 7) contaCliente1.sacar(200, new Date(2022, mes, 8));

  contaCliente1.depositar(200, new Date(2022, mes, 1));

  console.log(
    `O saldo para o mês ${mes}, já acrescido de rendimentos, é: ${contaCliente1.calcularSaldo()}.`
  );
}
